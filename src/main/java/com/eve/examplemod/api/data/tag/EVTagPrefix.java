...
import static com.eve.examplemod.api.data.material.info.EVMaterialFlags.GENERATE_NUCLEAR;
...
public class EVTagPrefix{
    ...
    public static final TagPrefix oxide = new TagPrefix("oxide").generateItem(true).idPattern("%s_oxide").generationCondition((material -> material.hasFlag(GENERATE_NUCLEAR))).langValue("%s Oxide").materialIconType(dust);
    public static final TagPrefix fuel_oxide = new TagPrefix("fuelOxide").generateItem(true).idPattern("%s_fuel_oxide").generationCondition((material -> material.hasFlag(GENERATE_NUCLEAR))).langValue("%s Fuel Oxide").materialIconType(fuel);
    public static final TagPrefix fuel_pure = new TagPrefix("fuelPure").generateItem(true).idPattern("%s_fuel_pure").generationCondition((material -> material.hasFlag(GENERATE_NUCLEAR))).langValue("Pure %s Fuel").materialIconType(fuel);
