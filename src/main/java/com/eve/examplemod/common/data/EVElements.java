...
public class EVElements {
    ...
    public static final Element Fm257 = createAndRegister(100,158, -1, null, "Fermium-257", "Fm257", true);
    public static final Element Fm258 = createAndRegister(100,158, -1, null, "Fermium-258", "Fm258", true);
    public static final Element Fm259 = createAndRegister(100,158, -1, null, "Fermium-259", "Fm259", true);
    public static final Element Fm262 = createAndRegister(100,158, -1, null, "Fermium-262", "Fm262", true);
    public static final Element Fm263 = createAndRegister(100,158, -1, null, "Fermium-263", "Fm263", true);
    public static final Element Md259 = createAndRegister(101, 160, -1, null, "Mendelevium-259", "Md259", true);
    public static final Element Md261 = createAndRegister(101, 160, -1, null, "Mendelevium-261", "Md261", true);
    public static final Element Md263 = createAndRegister(101, 160, -1, null, "Mendelevium-263", "Md263", true);
    public static final Element Es253 = createAndRegister(99, 156, -1, null, "Einsteinium-253", "Es253", true);
    ...
    public static final Element Cf257 = createAndRegister(99, 156, -1, null, "Californium-257", "Cf257", true);
    ...
    public static final Element Cf251 = createAndRegister(99, 156, -1, null, "Californium-251", "Cf251", true);
    ...
    public static final Element Cm251 = createAndRegister(99, 156, -1, null, "Curium-251", "Cm251", true);
    ...
    public static final Element Am241 = createAndRegister(99, 156, -1, null, "Americium-241", "Am241", true);
