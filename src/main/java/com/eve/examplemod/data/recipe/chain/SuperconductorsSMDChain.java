...
public class SuperconductorsSMDChain {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        // Cu + In + Ga -> CuGaIn
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(120)
        ...
        // 2H + Se -> H2Se
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(180).EUt(120)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(180).EUt(480)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(170).EUt(30)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(380).EUt(120).blastFurnaceTemp(900)
        ...
        // Fe + Pt -> FePt
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(230).EUt(240)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(120)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(480)
        ...
        CHEMICAL_BATH_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(350).EUt(1920)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(270).EUt(120).blastFurnaceTemp(1250)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(350).EUt(30)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(480)
        ...
        // NaNO3 -> Na + N + 3O
        ELECTROLYZER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(270).EUt(30)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(300).EUt(1920)
        ...
        // BaCl3 + H2O -> [BaCl3 + H2O]
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(230).EUt(120)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(120)
        ...
        CHEMICAL_DEHYDRATOR_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(58).EUt(1920)
                .inputFluids(BariumTitanatePreparation.getFluid(100))
                .outputItems(dust, BariumTitanate)
                .save(provider);

        // H2S + C4H6O4 + 4Br -> C4Br4S + 4H2O
        CHEMICAL_PLANT_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(230).EUt(4960)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(80).EUt(480)
        ...
        CHEMICAL_PLANT_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(1920)
        ...
        // Fe + H2SO4 -> FeSO4 + 2H
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(250).EUt(30)
                .inputItems(dust, Iron)
                .inputFluids(SulfuricAcid.getFluid(1000))
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(150).EUt(120)
        ...
        // Pb + N2O4 + 2O -> Pb(NO3)2
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).EUt(120).duration(150)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(430).EUt(30720)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(500).EUt(120).blastFurnaceTemp(2400)
                .inputItems(dust, Tungsten, 9)
                .inputItems(oxide, Thorium)
                .outputItems(ingot, ThoriumDopedTungsten, 10)
                .save(provider);

        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(270).EUt(120).blastFurnaceTemp(1800)
        ...
        ALLOY_BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(290).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(480)
        ...
        FLUID_HEATER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(200).EUt(480)
                .circuitMeta(1)
                .inputFluids(IronCarbonyl.getFluid(1000))
                .outputFluids(PurifiedIronCarbonyl.getFluid(900))
                .save(provider);

        ELECTROLYZER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(340).EUt(480)
                .inputFluids(PurifiedIronCarbonyl.getFluid(1000))
                .outputItems(CarbonylPurifiedIron)
                .outputFluids(CarbonMonoxide.getFluid(5000))
                .save(provider);

        ASSEMBLER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(290).EUt(1920)
                // TODO small coil
//                .inputItems(SMALL_COIL,4)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(180).EUt(120).blastFurnaceTemp(650)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(340).EUt(120).blastFurnaceTemp(1200)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(160).EUt(480)
        ...
        for (int i = 0; i < 5; i++) {
            MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(30)
            ...
            ASSEMBLER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(1920)
            ...
            if (i == 4) {
                ...
                ASSEMBLY_LINE_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(210).EUt(7680)
                        .inputItems(dust, mixtures.get(i))
                        .inputItems(foil, Molybdenum, 2)
                        .inputItems(wireFine, ThoriumDopedTungsten, 4)
                        .inputItems(ALUMINO_SILICATE_GLASS_TUBE)
        ...
        // 6F + 2CS2 -> C2F6S2 + 2S
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(250).EUt(120)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(480)
                .inputFluids(Mercury.getFluid(1000))
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(200).EUt(480)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(100).EUt(1024)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(7680)
                .inputFluids(Glycerol.getFluid(1000))
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(7680)
        ...
        ASSEMBLER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(360).EUt(122880)
        ...
        ARC_FURNACE_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(30720)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(120).EUt(480)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(180).EUt(30720)
        ...
        // C + 4Cl -> CCl4
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(30)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(530).EUt(120)
        ...
        STELLAR_FORGE_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(7800000)
        ...
        PLASMA_CONDENSER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(340).EUt(8380000)
        ...
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(140).EUt(30720)
        ...
        LARGE_ENGRAVER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(1966080)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(680).EUt(120).blastFurnaceTemp(2400)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(110).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(360).EUt(7680)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(210).EUt(120).blastFurnaceTemp(4500)
        ...
        // 2Cl + C2H6 -> C2H5Cl + HCl
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(200).EUt(3340)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(7680)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(290).EUt(30720)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(200).EUt(480)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(7680)
                .inputFluids(TitaniumTetrachloride.getFluid(1000))
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(7920).EUt(120).blastFurnaceTemp(3500)
        ...
        // This is correct
        // > ok
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(20250).EUt(120).blastFurnaceTemp(5000)
                .inputItems(BETS)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(40).EUt(120)
        ...
        // NaBr -> Na + Br
        ELECTROLYZER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(120)
        ...
        // 2Fr + C2H2 -> Fr2C2 + 2H
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(480)
        ...
        // 4B + 3C -> B4C3
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(550).EUt(120).blastFurnaceTemp(4000)
        ...
        // 2Fr2C2 + B4C3 -> Fr4B4C7
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(1920)
        ...
        // At + H2SO4 -> [At + H2O + SO3]
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(140).EUt(7680)
        ...
        MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(380).EUt(30720)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(15000).EUt(120).blastFurnaceTemp(11300)
        ...
        ELECTROLYZER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(260).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(290).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(240).EUt(1920)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(220).EUt(480)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(820).EUt(30720)
        ...
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(1360).EUt(120).blastFurnaceTemp(4500)
                .inputItems(dust, SodiumRuthenate, 7)
        ...
        // Os + 4O -> OsO4
        ARC_FURNACE_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(520).EUt(4800)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(220).EUt(7680)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(210).EUt(7680)
                .notConsumable(UVA_HALIDE_LAMP)
        ...
        // Ir + 2O -> IrO2
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(280).EUt(120).blastFurnaceTemp(700)
        ...
        // Kr + 2F -> KrF2
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(170).EUt(480)
                .notConsumable(UVA_HALIDE_LAMP)
        ...
        // MnF2 + O + H2O -> MnO2 + 2HF
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(160).EUt(120)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(320).EUt(122880)
                .inputFluids(Phenol.getFluid(1000))
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(210).EUt(30720)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(250).EUt(122880)
        ...
        // Hs + 4Cl -> HsCl4
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(930).EUt(120).blastFurnaceTemp(12000)
        ...
        // Re + 5Cl -> ReCl5
        BLAST_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(930).EUt(120).blastFurnaceTemp(12500)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(280).EUt(7680)
        ...
        // SbCl3 + 3HF -> SbF3 + 3HCl
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(210).EUt(480)
        ...
        LARGE_CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(620).EUt(845000)
        ...
        LARGE_MIXER_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(270).EUt(250000)
        ...
        CHEMICAL_PLANT_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(520).EUt(445000)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(290).EUt(320000)
        ...
        CHEMICAL_RECIPES.recipeBuilder("circuit_components_" + chainNumber++).duration(100).EUt(120)
                .inputItems(dust, Lanthanum, 2)
                .inputFluids(SulfuricAcid.getFluid(1000))
