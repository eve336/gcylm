...
import static com.eve.examplemod.common.data.EVMaterials2.PotassiumNitrate;
...
public class IodineChain {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        // todo maybe leave this in but idk lmao
        // gtm iodine chain probably more interesting tbh lol
